...
def najdluzszy_podciag_niemalejacy(liczby):
...
def main():
  ...
  naj_dluzszy_podciag = najdluzszy_podciag_niemalejacy(liczby)
  print(f"Najdłuższy spójny podciąg niemalejący: {naj_dluzszy_podciag}")
